        ...
        <div class="sb-sidenav-menu">
            @can('admin')
                <div class="nav">
                    ...
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#website-controller"
                        aria-expanded="false" aria-controls="website-controller">
                        <div class="sb-nav-link-icon"><i class="fas fa-sliders-h"></i></div>
                        Website Controller
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>

                    <div class="collapse" id="website-controller" aria-labelledby="headingOne"
                        ...
                        <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link" href="{{ route('greetingmessages.index') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-ellipsis-h"></i></div>
                                Greeting Messages
                            </a>
                        </nav>
                    ...
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                        data-bs-target="#academic-information" aria-expanded="false" aria-controls="academic-information">
                        <div class="sb-nav-link-icon"><i class="fas fa-school"></i></div>
                        Academic Info
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>

                    <div class="collapse" id="academic-information" aria-labelledby="headingOne"
                        data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                    ...
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#yearly-updates"
                        aria-expanded="false" aria-controls="yearly-updates">
                        <div class="sb-nav-link-icon"><i class="fas fa-calendar-week"></i></div>
                        Yearly Updates
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>

                    <div class="collapse" id="yearly-updates" aria-labelledby="headingOne"
                        data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
            ...
            @can('student')
                <div class="nav">
                   ...
                   Student Registration
                    ...
                    <a class="nav-link"
                        href="{{ route('teacher.evaluation.show', ['student_id' => auth()->user()->id, 'year' => date('Y')]) }}">
                        <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                        Teacher Evaluation
                    </a>
