            ...
            <div class="shell">
                ...
                <div class="offset-sm-top-35">
                    <ul class="list-inline list-inline-lg list-inline-dashed p">
                        ...
                        <li style="color:yellow;">COO Message&nbsp;</li>
                    </ul>
                </div>
            </div>
        </div>
          ...
          <div class="media block-6 d-block text-center">
            <a href="#">
              <div class="box  d-flex justify-content-center align-items-center mt-5 mb-3">
                <img src="{{ asset('storage/greeting/' . $COO->img ) }}" class="d-block  mx-auto mt-2 " alt="..." style=" width:150px; height:150px;  border-radius:50%; border:2px solid #e2b75a">
              </div>
            </a>
            <div class="title media-body p-2 mt-3">
              <h3 class="heading  mt-3" style="margin:0 auto; ">COO, SBF-B</h3>
              <p class="mb-0" style="margin:0 auto; font-size: 14px; color: #000000; font-weight: 500;">{{ $COO->name ?? '' }}</p>
              <p class="">{{ $COO->greeting_messages ?? '' }} </p>
            </div>
          </div>
