        ...
        <div class="card-body">
          <div class="d-flex flex-column align-items-center text-center">
            ...
            @if ($teacher->img)
              ...
              <img src="{{ asset('storage/teachers/'.$teacher->img) }}" alt="{{$teacher->name }}" class="rounded-circle" width="150">
            @else
              "No Image"
            @endif
      ...
      <div class="card mb-3">
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-9 text-secondary">
              {{ $teacher->designation ?? 'Edit Profile'}}
            </div>
          </div>
          <hr>
          <div class="row">
